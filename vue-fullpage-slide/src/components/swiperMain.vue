<template>
  <div class='home'>
    <swiper :options='swiperOption' ref='swiperFullPage'>
...
<script>
import pageOne from '@/components/swiperPageOne';
import pageTwo from '@/components/swiperPageTwo';
import pageThree from '@/components/swiperPageThree';
import pageFour from '@/components/swiperPageFour';
...
export default {
    ...
    computed: {
        swiper() {
            return this.$refs.swiperFullPage.swiper;
        }
    },
    mounted() {
